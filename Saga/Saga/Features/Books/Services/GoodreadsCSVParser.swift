...
extension Dictionary where Key == String, Value == String {
  fileprivate func value(for field: BookCSVField) -> String? {
    self[field.rawValue]
  }
}
...
struct GoodreadsCSVParser {
  ...
  private static func makeImportContext(from context: NSManagedObjectContext)
  ...
  private static func parseRows(
    into parentContext: NSManagedObjectContext,
